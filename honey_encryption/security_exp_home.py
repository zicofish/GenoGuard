...
#     sizes[orgInd] = 150
    ...
    ax1.text(500, -8000, '(a)', fontsize=16)
    ax1.legend((h1, h2),
    ...
    ax2.text(500, 37440, '(b)', fontsize=16)
...
def produce_results():
    test_AF, test_LD = loadPriorKnowledge("E:/Lab/LCA1/honeygenes/data/hg_allele_freqs_chr22_CEU.txt",
                                "E:/Lab/LCA1/honeygenes/data/hg_ld_chr22_CEU.txt")
    
    SNPRefList = []
    dataset = []
    datFile = open("E:/Lab/LCA1/honeygenes/data/new_genotypes_chr22_CEU.txt")
...
#    produce_results()
    plotResult("sec_exp_result_large.txt")
#     test_AF, test_LD = loadPriorKnowledge("C:/Users/zhihuang/Desktop/data/hapmap/hg_allele_freqs_chr22_CEU.txt",
